const foodItems = [
    ...
    { name: "Pasta - Kes 1200", img: "https://i.pinimg.com/736x/91/f4/75/91f475ea479986f068cc8a9fd7517bca.jpg" },
...
function addToCart(itemName) {
    cart.push(itemName);
    customAlert(`${itemName} has been added to your cart!`);
}
...
function checkout() {
    if (cart.length === 0) {
        ...
        customAlert(`Checking out: ${cart.join(', ')}`);
    }
}
